...
<Callout>In the Token Bid-Ask strategy, you gradually sell your tokens (eg. memecoins, mid-cap tokens) for SOL across a predefined range - ideal for profit taking as price rises.</Callout>
This Strategy saves you from losing money in Slippage.
       <img src="../../../bid-ask-token.png" width="500" height="500"></img>
