...
description: The Curve strategy is an LP approach that concentrates liquidity in the middle of the price range, particularly effective for stable asset pairs or markets with minimal price volatility.
--- 

## DLMM Curve LP Strategy
       <img src="/curve-position.png" width="500" height="500"></img>
