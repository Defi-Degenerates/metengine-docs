...
If you try to reopen a position in the same DLMM pool within 5 minutes, NO ADDITIONAL FEES will be charged. After 5 minutes has passed, opening a new position will be treated as a fresh transaction with normal fees structure. 
