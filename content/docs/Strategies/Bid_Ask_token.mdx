...
<Callout> In Token Bid-Ask strategy, you sell your Tokens(Eg. Memecoins,Mid cap tokens) to get the Sol in a set of range</Callout>
This Strategy saves you from losing money in Slippage.
       <img src="../../../bid-ask-token.png" alt="A wild meteor" width="500" height="500"></img>
