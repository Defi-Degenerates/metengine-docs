...
1. **Open Position**: Manually open a new LP position using this feature.  
   ...
   • You can open positions in any strategy supported by Meteora via MetEngine.
...
4. **Manage Wallet**: Access everything related to your MetEngine wallet. Includes a built-in swapper to convert tokens to SOL without leaving the bot.
